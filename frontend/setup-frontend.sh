...
if [ ! -f ".env.local" ]; then
    ...
    echo -e " ${YELLOW}║                                                                  ║${RESET}"
    echo -e " ${YELLOW}║  Required secrets:                                               ║${RESET}"
    echo -e " ${YELLOW}║    BEDROCK_MODEL_ID                                              ║${RESET}"
    echo -e " ${YELLOW}║    AWS_ACCESS_KEY_ID / AWS_SECRET_ACCESS_KEY                     ║${RESET}"
    echo -e " ${YELLOW}║    OPENSEARCH_HOST                                               ║${RESET}"
    echo -e " ${YELLOW}║    DATABASE_URL                                                  ║${RESET}"
    echo -e " ${YELLOW}║                                                                  ║${RESET}"
